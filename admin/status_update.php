...
<head>
<meta charset="UTF-8">
<title>Update Status | IdeaInvest</title>
...
.sidebar .logo { text-align:center !important; font-weight:700 !important; font-size:20px !important; margin-bottom:30px !important; }
.sidebar a { padding:12px 15px !important; border-radius:10px !important; display:flex !important; align-items:center !important; gap:12px !important; font-weight:500 !important; }
...
<div class="sidebar" id="sidebar">
  <div class="logo"><i class="fa-solid fa-lightbulb"></i> IdeaInvest</div>
...
<div class="main" id="mainContent">
  ...
  <footer>
    © <?= date("Y") ?> IdeaInvest — Admin Dashboard
  </footer>
</div>
