...
// Handle profile picture upload (same UI/behavior as before)
if ($_SERVER['REQUEST_METHOD'] === 'POST' && isset($_FILES['profile_pic'])) {
    ...
    if (in_array($ext, $allowed)) {
        ...
        // fetch old pic from users table
...
<style>
/* same CSS as you provided (kept identical) */
...
<div class="sidebar">
  <div>
    ...
    <a href="admin_projects.php"><i class="fa-solid fa-folder-open"></i> Projects</a>
